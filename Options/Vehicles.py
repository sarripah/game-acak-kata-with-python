...
VEHICLES_WORD = ['ELHIOKPERT', 'ESPAAWT', 'TEKOR', 'AOTBILSA', 'AAPLK ESIAPR', 'AAPLK RGOAC', 'TJE IKS', 'AJJAB',
                 'ERAUHP', 'AAKPL', 'AAKPL ESLAM', 'ADEEPS', 'LIBOM', 'SIB', 'ATEREK', 'UTKR', 'LIBOM ANV', 'OMROT', ]

VEHICLES_ANSWER = ['HELIKOPTER', 'PESAWAT', 'ROKET', 'SAILBOAT', 'KAPAL PESIAR', 'KAPAL CARGO', 'JET SKI',
                   'BAJAJ', 'PERAHU', 'KAPAL', 'KAPAL SELAM', 'SEPEDA', 'MOBIL', 'BIS', 'KERETA', 'TRUK', 'MOBIL VAN',
                   'MOTOR', ]
