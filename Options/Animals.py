...
ANIMALS_WORD = ['UURBNG', 'NGIJAN', 'EEKLADI', 'EAARPJH', 'ILAOTGAR', 'NGIKUC', 'UAKD', 'ANIGS', 'EOTNMY', 'ABELH', 'EEBBK',
                'TAAKK', 'AAJGH', 'UBAAY', 'UBAML-UBAML', 'IRGLAO', 'SUKIT', 'IAARHMU', 'INCEKLI', 'NGETABN', ]

ANIMALS_ANSWER = ['BURUNG', 'ANJING', 'KELEDAI', 'JERAPAH', 'ALIGATOR', 'KUCING', 'KUDA', 'SINGA', 'MONYET', 'LEBAH', 'BEBEK',
                  'KATAK', 'GAJAH', 'BUAYA', 'LUMBA-LUMBA', 'GORILA', 'TIKUS', 'HARIMAU', 'KELINCI', 'BANTENG', ]
