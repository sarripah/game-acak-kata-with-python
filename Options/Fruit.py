...
FRUITS_WORD = ['EAPL', 'UAMBJ', 'SIKERP', 'RIP', 'AGNGMA', 'EAAPPY', 'UERJK', 'GUGNAR', 'WIKI', 'CIRE', 'MEAANGSK',
               'AASNN', 'BELUEBRRY', 'ISAPNG', 'AAEPLK', 'EEENGKNGLK', 'MONLE', 'EREYBMUL', 'MASA WJAA']

FRUITS_ANSWER = ['APEL', 'JAMBU', 'PERSIK', 'PIR', 'MANGGA', 'PEPAYA', 'JERUK', 'ANGGUR', 'KIWI', 'CERI',
                 'SEMANGKA', 'NANAS', 'BLUEBERRY', 'PISANG', 'KELAPA', 'KELENGKENG', 'LEMON', 'MULBERRY',
                 'ASAM JAWA']
